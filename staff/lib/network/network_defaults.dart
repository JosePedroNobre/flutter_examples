...
enum NetworkDefaultsKeys { TOKEN, REFRESH_TOKEN, USER_NAME }
...
class NetworkDefaults {
  ...
  static getUserName() async {
    final p = await prefs;
    return p
        .getString(NetworkDefaultsKeys.USER_NAME.toString())
        .replaceAll(new RegExp('"'), '');
  }

  static setUserName(String name) async {
    save(NetworkDefaultsKeys.USER_NAME.toString(), name);
  }
