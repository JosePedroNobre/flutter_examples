...
import 'package:staffapp/env/main_common.dart';
...
import 'package:staffapp/network/model/requests/refresh_token_request.dart';
...
class ServicesBaseApi {
  ...
  static Future<AuthenticationResponse> refreshToken(String token) async {
