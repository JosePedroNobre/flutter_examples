...
class ReplenishmentCard extends StatefulWidget {
  final ReplenishmentTask task;
  final TaskCardState cardState;
  final Function(ReplenishmentTask task) onScan;
  ...
  @override
  _ReplenishmentCardState createState() => _ReplenishmentCardState();
}

class _ReplenishmentCardState extends State<ReplenishmentCard> {
  @override
  ...
  _buildTaskLeftSection(ReplenishmentTask task) {
    return Padding(
  ...
  _buildTaskBottomSection(ReplenishmentTask task) {
  ...
  _buildTaskRightSection(ReplenishmentTask task) {
