...
import 'package:customer/features/authentication/presentation/phone_association_screen.dart';
import 'package:flutter/material.dart';
import 'package:pin_code_fields/pin_code_fields.dart';

class OptEmailInputScreen extends StatefulWidget {
  final String email;

  OptEmailInputScreen({this.email});

  @override
  _OptEmailInputScreenState createState() => _OptEmailInputScreenState();
}

class _OptEmailInputScreenState extends State<OptEmailInputScreen> {
  ...
  _buildSubtitle() {
    return Padding(
        ...
        child: RichText(
          text: TextSpan(
            text:
                'Before continuing, you need to verify your email address. The verification code has been sent to ',
            style: font2(
                size: 16,
      ...
      child: PinCodeTextField(
        ...
        onCompleted: (v) {
          ...
          Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => PhoneAssociationScreen(),
              ));
        },
        onChanged: (value) {
          if (value.length < 6) {
                ...
                child: RaisedButton(
                  onPressed: isButtonEnable
                      ? () {
                          ...
                          print("phoneNumber : " + widget.email);
                          // TODO make api call to check if the code is ok if so make this push
                          Navigator.push(
                              context,
                              MaterialPageRoute(
