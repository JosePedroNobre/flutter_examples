...
import 'package:customer/features/authentication/presentation/email_association_screen.dart';
import 'package:customer/features/authentication/presentation/opt_input_screen.dart';
import 'package:customer/features/registration/pages/registration_name_screen.dart';
...
enum PhoneInputContext { LOGIN, RECOVER }

class PhoneInputScreen extends StatefulWidget {
  final PhoneInputContext phoneInputContext;

  PhoneInputScreen({this.phoneInputContext});
  @override
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => EmailAssociationScreen()),
                      );
                    },
                    child: Text(
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => OtpInputScreen(
                                onOtpSuccess: () {
                                  // TODO make api call to check if the code is ok if so make this push according to the context
                                  if (widget.phoneInputContext ==
                                      PhoneInputContext.LOGIN) {
                                    Navigator.of(context).pushReplacement(
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                ResgistrationNameScreen()));
                                  } else {
